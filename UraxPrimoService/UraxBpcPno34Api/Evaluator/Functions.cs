...
namespace URAX
{
    public class Functions : Dictionary<string, Function>
    {
        ...
        public void InitDefaults()
        {
            ...
            this.Add("about", new StaticFunction("About", delegate (object[] ps) { return "@URAX - a Urax Expression Evaluator"; }, 0, 0));
            ...
            this.Add("round", new StaticFunction("Round", delegate (object[] ps) { return Math.Round(Convert.ToDouble(ps[0]), Convert.ToInt32(ps[1])); }, 2, 2));

            this.Add("roundup", new StaticFunction("Roundup", delegate (object[] ps) { return RoundUpdetails(Convert.ToDouble(ps[0]), Convert.ToInt32(ps[1])); }, 2, 2));


            this.Add("rounddown", new StaticFunction("Rounddown", delegate (object[] ps) { return RoundDowndetails(Convert.ToDouble(ps[0]), Convert.ToInt32(ps[1])); }, 2, 2));
        ...
        /// <returns></returns>
        public static double RoundDowndetails(double input, int places)
        {
        ...
        /// <param name="places"></param>
        /// <returns></returns>
        public static double RoundUpdetails(double input, int places)
        {
            double multiplier = Math.Pow(10, Convert.ToDouble(places));
        ...
        private static object Help(object[] ps)
        {
            ...
            help.AppendLine("Urax Expression Evalutator can evaluate expression containing the following functions:");
